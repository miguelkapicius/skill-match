...
export function LoadingView() {
  return (
    <div className="flex flex-col items-center justify-center gap-12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-xl w-full mx-auto">
